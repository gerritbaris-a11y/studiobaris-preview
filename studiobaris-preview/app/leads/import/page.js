...
export default function LeadsImportPage() {
  ...
  return (
    <main style={{ maxWidth: 760, margin: "5vh auto", padding: "0 20px", fontFamily: "system-ui, sans-serif", color: "#222" }}>
      ...
      <p style={{ marginTop: 28 }}>
        <a href="/leads" style={{ color: "#1d6fd1", fontSize: 14 }}>&larr; Terug naar de leadlijst</a>
      </p>
    </main>
  );
}
